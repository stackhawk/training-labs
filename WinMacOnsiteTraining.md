...
```powershell:Installing HawkScan using Windows MSI installer
msiexec.exe /i https://download.stackhawk.com/hawk/msi/latest /passive
```
...
>v4.5.0 is the latest as of 5/1/2025
