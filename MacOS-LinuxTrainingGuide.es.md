...
```
curl -v https://download.stackhawk.com/hawk/pkg/hawk-4.8.0.pkg -o hawk-4.8.0.pkg &&\
sudo installer -pkg hawk-4.8.0.pkg -target /Applications &&\
rm hawk-4.8.0.pkg
```
